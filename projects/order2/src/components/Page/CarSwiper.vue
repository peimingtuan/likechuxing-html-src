  ...
  <div class="CarSwiper">
    <div class="swiper-container" id="carSwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide car_card" v-for="item in car_list">
          <div class="plate_no">
            {{item.plate_no}}
      ...
      <div class="swiper-pagination swiper-pagination-bullets" :class="{hide:car_list.length<2}"></div>
    </div>
  </div>
</template>
      ...
      swiper = new Swiper('#carSwiper', {
        ...
        on: {
          slideChangeTransitionEnd: function(){
            store.commit('branch/setActiveCar',that.car_list[this.activeIndex])
          }
        }
      });
    },

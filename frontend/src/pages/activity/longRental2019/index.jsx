...
import Renew from './pages/rental/renew'
...
import ExplainFeeBaozhang from './pages/explains/feeBaozhang'
...
import Explainprice from './pages/explains/price'
import ExplainTime from './pages/explains/time'
import ExplainRenew from './pages/explains/renew'
...
history.listen(res=>{
    if(res.pathname!='/carDamage/review'){
        document.querySelector('.large_img_container') && document.body.removeChild(document.querySelector('.large_img_container'))
    }
})
// 路由
        ...
        return (
            <Router>
                <Switch>
                    ...
                    <Route path="/explains/feeBaozhang" component={ExplainFeeBaozhang}/>
                    ...
                    <Route path="/explains/price" component={Explainprice}/>
                    <Route path="/explains/time" component={ExplainTime}/>
                    <Route path="/explains/renew" component={ExplainRenew}/>
                    ...
                    <Route path="/rental/renew" component={Renew}/>
...
// if(appArguments.app_version < 2202){
//     new Alert({
//         title: '请升级APP',
//         msg: '请升级至最新版app参与活动',
...
// }else{
    ...
    if(appArguments.isLogin){
        ...
        // new Alert({
        //     title: '<span class="login">您还没登录哦</span><br/>',
        //     msg: '<span class="loginMsg">请前往登录</span>',
        //     confirmButtonCallback: function(){
        //         newAppMutual.jump.loginAndCloseThisWebview({
        //             destroy_current: 1
        //           })
        //     }
        // })

...
import zipImage from '../../js/switchBase64'
...
class PhotoBox extends React.Component{
    ...
    componentDidMount(){
        appMutual.send.updateTitle('拍摄车辆')
        let that = this
    ...
    render() {
        ...
        return <div className="TakePhoto">
                ...
                <div className="takePhoto">
                    ...
                    <div className="takePhoneBtn"><a className={"fs14 btn_long "+(this.state.finish?"":'disabled')} onClick={this.submit.bind(this)}>{btn_text}</a></div>
                </div>
        </div>
    }
}

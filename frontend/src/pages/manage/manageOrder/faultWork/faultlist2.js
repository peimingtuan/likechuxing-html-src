...
require('../css/faultWork/faultlist2.css')
import $ from 'jquery'
...
$('.faultList').height($(window).height() - $('.faultlist-content').height() - $(".faultlist-map").height());
...
$(".close-btn2").on("click",function(){
    $(".faultlist_window2").addClass("none");
    $(".faultlist_window").removeClass("none");
});
//关闭上报故障类型弹框
$(".close-btn3").on("click",function(){
    $(".faultlist_window3").addClass("none");
    $(".faultlist_window").removeClass("none");
});
...
$(".faulttype-list").on("click", "li", function () {
    ...
    $(".choice").text("全部");
    $(".choice-type3").text($(this).find("span").text());
    $(".choice-type3").removeClass("none");
    //获取对应的二级菜单数据
...
//优化新增逻辑
$(".choice-type3").on("click",function(){
    $(this).addClass("none");
...
$(".content .bold").on("click", function () {
    $(".faultlist_window").addClass("none");
    $(".faultlist_window2").removeClass("none");
});
...
$(".content2 .bold").on("click", function () {
    $(".faultlist_window").addClass("none");
    $(".faultlist_window3").removeClass("none");
});
...
$(".faulttype-list2").on("click", "li", function () {
    ...
    $(".choice2").text("全部");
    $(".choice-type4").text($(this).find("span").text());
    $(".choice-type4").removeClass("none");
    //获取对应的二级菜单数据
    let str = '<li><span class="font-color">全部</span><img class="" src="' + require("../image/faultWork/duigou.png") + '"/><input type="hidden" value=""/></li>';
    if ($(this).find("input").val() != '') {
...
//优化新增逻辑
$(".choice-type4").on("click",function(){
    $(this).addClass("none");
    $(".faultchoice-list2").addClass("none");//二级隐藏
    $(".faulttype-list2 li span").removeClass("font-color");
    $(".faulttype-list2 li img").addClass("none");
    $(".faulttype-list2").removeClass("none");//一级显示
});

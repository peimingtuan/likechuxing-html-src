    ...
    if ($(".search-car").val() == '') {
        ...
        $.post(getApiUrl('/work-order/search'), param, function (data) {
            ...
            if (data.length == 0) {
                ...
                if (data.length == '1') {
                    if (type == '1') {
                        window.location.href = "./carwoundpicture2.html?name=" + data[0].name + "&branch_id=" + data[0].branch_id + "&lng=" + data[0].lng + "&lat=" + data[0].lat + "&type=1";
                    } else if (type == '2') {
                        window.location.href = "./carwoundpicture2.html?name=" + data[0].name + "&branch_id=" + data[0].branch_id + "&lng=" + data[0].lng + "&lat=" + data[0].lat + "&type=2";
                    } else if (type == '3') {
                        window.location.href = "./carwoundpicture2.html?name=" + data[0].name + "&branch_id=" + data[0].branch_id + "&lng=" + data[0].lng + "&lat=" + data[0].lat + "&type=3";
                    } else if (type == '4') {
                        window.location.href = "./carwoundpicture2.html?name=" + data[0].name + "&branch_id=" + data[0].branch_id + "&lng=" + data[0].lng + "&lat=" + data[0].lat + "&type=4";
                    } else if (type == 'endfinsh') {
                        window.location.href = "./carwoundpicture2.html?name=" + data[0].name + "&branch_id=" + data[0].branch_id + "&lng=" + data[0].lng + "&lat=" + data[0].lat + "&type=endfinsh";
                    } else if (type == '5') {
                        window.location.href = "./carwoundpicture2.html?name=" + data[0].name + "&branch_id=" + data[0].branch_id + "&lng=" + data[0].lng + "&lat=" + data[0].lat + "&type=5";
                    } else if (type == '6') {
                        window.location.href = "./carwoundpicture2.html?name=" + data[0].name + "&branch_id=" + data[0].branch_id + "&lng=" + data[0].lng + "&lat=" + data[0].lat + "&type=6";
                    } else if (type == '7') {
                        window.location.href = "./carwoundpicture2.html?name=" + data[0].name + "&branch_id=" + data[0].branch_id + "&lng=" + data[0].lng + "&lat=" + data[0].lat + "&type=7";
                    }
                } else {
                    let str = '';
                    for (var i = 0; i < data.length; i++) {
...
$(".searchnetwork-list").on('click', 'li', function () {
    ...
    if ($(this).hasClass("winding")) {
        ...
        $.post(getApiUrl('/work-order/search'), param, function (data) {
            ...
            if (status == '0') {
                if (type == '1') {
                    window.location.href = "./carwoundpicture2.html?lng=" + param.lng + "&lat=" + param.lat + "&branch_id=" + param.branch_id + "&type=1";
                } else if (type == '2') {
                    window.location.href = "./carwoundpicture2.html?lng=" + param.lng + "&lat=" + param.lat + "&branch_id=" + param.branch_id + "&type=2";
                } else if (type == '3') {
                    window.location.href = "./carwoundpicture2.html?lng=" + param.lng + "&lat=" + param.lat + "&branch_id=" + param.branch_id + "&type=3";
                } else if (type == '4') {
                    window.location.href = "./carwoundpicture2.html?lng=" + param.lng + "&lat=" + param.lat + "&branch_id=" + param.branch_id + "&type=4";
                } else if (type == 'endfinsh') {
                    window.location.href = "./carwoundpicture2.html?lng=" + param.lng + "&lat=" + param.lat + "&branch_id=" + param.branch_id + "&type=endfinsh";
                } else if (type == '5') {
                    window.location.href = "./carwoundpicture2.html?lng=" + param.lng + "&lat=" + param.lat + "&branch_id=" + param.branch_id + "&type=5";
                } else if (type == '6') {
                    window.location.href = "./carwoundpicture2.html?lng=" + param.lng + "&lat=" + param.lat + "&branch_id=" + param.branch_id + "&type=6";
                } else if (type == '7') {
                    window.location.href = "./carwoundpicture2.html?lng=" + param.lng + "&lat=" + param.lat + "&branch_id=" + param.branch_id + "&type=7";
                }
            } else {
                new Toast(msg)
            }

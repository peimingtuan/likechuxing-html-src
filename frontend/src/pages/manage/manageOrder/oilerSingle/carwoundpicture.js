    ...
    dd.device.geolocation.get({
        ...
        onSuccess: function (result) {
            ...
            var name = FoundationTools.getUrlParam('name'),//网点名称
                type = FoundationTools.getUrlParam('type'),//区分来源
            ...
            myAjax.post(getApiUrl(nozzleaddress), param, function (data) {
                var result = data,
                ...
                //获取加油站信息
                myAjax.post(getApiUrl('/work-order/display-gas'), paramoiler, function (data) {
            ...
            $(".networkname-top .icon").on("click", function () {
                if (type == 1) {
                    window.location.href = "./searchnetwork.html?type=1";
                } else {

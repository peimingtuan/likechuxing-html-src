...
require('../css/oilerSingle/endworklist.css')
import $ from 'jquery'
...
$(".endwork-netname").on("click", function () {
    ...
    window.location.href = "./networkname.html"
})
//激活提交按钮
...
$(".endworkname-submit button").on("click", function () {
    if ($(this).hasClass('endworkname-button')) {
        if ($(".car-stateid").val() == '32' || $(".car-stateid").val() == '31' || $(".car-stateid").val() == '25' || $(".car-stateid").val() == '33' || $(".car-stateid").val() == '23' || $(".car-stateid").val() == '20') {//状态为故障，维修，保养，保险,车辆整备，办公用车
        ...
        if (clicktag == 0) {
            ...
            var time = window.setTimeout(function () {
                ...
                setTimeout(function () {
                    window.location.href = "./oiler.html";
                }, 2000);
            }, 10000);
            let param = {
                mobile: sessionStorage.getItem("mobile"),

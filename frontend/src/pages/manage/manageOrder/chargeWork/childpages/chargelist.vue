...
<template>
    <div id="chargelist">
        <div class="charge-content">
            <span class="chargeSelect">&#xe605;&nbsp;&nbsp;搜索</span>
            <span class="chargeFilter">&#xe638;&nbsp;&nbsp;筛选</span>
            <span class="chargeRefle">&#xe8d0;&nbsp;&nbsp;刷新</span>
        </div>
        <ul class="charge-List">
            <!--<li>-->
            <!--<input type="hidden" value="1353" class="order_id">-->
            <!--<input class="carworkstate" type="hidden" value="1">-->
            <!--<span>京AF23K5 （<font class="font1">LVVDB17B7GB</font>111495）</span>-->
            <!--<span class="right">充电1353</span><br/>-->
            <!--<span>充电中上线</span>-->
            <!--<span>约续航120公里</span>-->
            <!--<span>奇瑞</span>-->
            <!--<span>充电中上线</span><br/>-->
            <!--<span class="work-time"><font>工单时长：</font>8小时56分</span>-->
            <!--</li>-->
        </ul>
        <!--confirm提示框-->
  ...
  export default {
    ...
    mounted () {
      ...
      var param = {
        ...
        city_id: sessionStorage.getItem('city_id') || FoundationTools.getCookie("city_id"),//城市id
        limit: 10,//每页大小
        page: '1'//页码
      };
      //手动固定父元素的高，否则scroll不起作用
      $('.charge-List').height($(window).height() - $('.charge-content').height());
      show(param)
      ...
      //跳转搜索页
      $(".chargeSelect").on("click", function () {
        window.location.href = "../../manageOrderMain/index.html#/list";
      });
      //记录打开弹框前已筛选的值
      var colorArray = [];
      //打开筛选弹框
      $(".chargeFilter").on("click", function () {
        colorArray = [];

    ...
    created () {
      this.init().then(res => {
        ...
        this.allInfo = {
          ...
          car_info: res.brand_name,
          total_km: res.coord_km,
          addrs: [
            {'icon_color': '1', 'icon_img': '取', 'branch_name': res.begin_branch, 'time': res.start_time},
            {'icon_color': '2', 'icon_img': '保', 'branch_name': res.maintain_branch, 'time': res.maintain_time},
            {'icon_color': '3', 'icon_img': '还', 'branch_name': res.end_branch, 'time': res.end_time}],
          remain: res.remain_km,
          end_coord_list: res.end_coord_list,
          maintain_coord_list: res.maintain_coord_list,

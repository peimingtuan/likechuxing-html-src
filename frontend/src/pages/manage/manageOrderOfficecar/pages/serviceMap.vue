...
//			          })
	    	...
	    	goEnd(){
	    		...
	    		if(this.isnext&&this.type!=2&&this.type!='3'){
	    			window.location.href="index.html#/endOrder?status_note="+this.$route.query.status_note+"&branch_id="+this.next_id+"&branch_name="+this.next_name+'&order_id='+this.$route.query.order_id
	    		}else if(this.type==2){

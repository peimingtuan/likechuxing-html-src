            ...
            >
        		<div class="car_card">
					<p class="car_plat">
						...
						<span class="car_status">{{listItem.car_status_text}}</span>
					</p>
					<div>
				...
				<div class="status_modal">
					...
					<p class="not_time">
						<span>办公类型：</span>
						<span class='fc33'>
							{{listItem.order_type_text}}
						</span>
					</p>
					<p class="not_time">
						<span class="note_title">办公缘由：</span>
						<span class='fc33 note_con'>
							{{listItem.remark}}
						</span>
					</p>
				</div>
    	...
    	citySatus(){
      	...
      	getList(){
      		var param = {
				...
				'status':this.zombie_status.join(',')||'-1',
				'order_type':this.branch_type,
				'is_main':0,

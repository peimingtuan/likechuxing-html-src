			...
			>
				...
				<div class="fc66 his_data">
					...
					<div>
						...
						<p v-if="item.remark" class="fc66">
							<span class="icon_addr" v-show="item.remark.biz_type">
								<img src="../images/de-back-B.png" alt=""  v-if='item.item_id==100&&item.remark.biz_type==0'/>
								<img src="../images/de-back-B+.png" alt="" v-if='item.item_id==100&&item.remark.biz_type==1'/>
								<img src="../images/de-get-B.png" alt=""  v-if='item.item_id==3&&item.remark.biz_type==0'/>
								<img src="../images/de-get-B+.png" alt="" v-if='item.item_id==3&&item.remark.biz_type==1'/>
							</span>
				...
				<div class="his_right">
					...
					<p class="check" v-if="item.item_id==2" @click="goIndex(item.id,item.item_id)">
						<span>查看</span>

...
//		          	userData.save({
//			            locationsLng: this.$route.query.lng||'116.3000100000',
//			            locationsLat: this.$route.query.lat||'40.0450500000',
//			            mobile:'13521758602',
//			            provice:'北京市',
//						city:'北京市'
//			          })
	    	...
	    	goEnd(){
	    		...
	    		if(this.isnext&&this.type!=2&&this.type!='3'){
	    			window.location.href="index.html#/endOrder?status_note="+this.$route.query.status_note+"&branch_id="+this.next_id+"&branch_name="+this.next_name+'&order_id='+this.$route.query.order_id+'&choice_floor='+this.choice_floor
	    		}else if(this.type==2){

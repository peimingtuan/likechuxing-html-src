	...
	<div class="endOrder">
		...
		<div class="fee_list">
				...
				<p>
					...
					<span class="center_txt">{{status_note!='undefined'?status_note:''}}</span>
				</p>
			</div>
        <div class="note">
        	<p>备注：</p>
        ...
        <div class="creat_btn" @click="createSub()">
			<p class="crea_submit" :class="floor_status>=1||floor_status=='地面'||floor_status!='地面'&&floor_status!='1'&&floor_status!='2'&&floor_status!='3'&&floor_status!='4'&&floor_status!='5'&&floor_status!='6'
				&&searchWord&&car_num?'subf33':'subfc8'">提交</p>
		</div>

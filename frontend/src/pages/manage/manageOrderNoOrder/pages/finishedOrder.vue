		...
		created(){
			this.init().then(res=>{
		     	...
		     	this.allInfo = {'plate_no':res.plate_no,'car_info':res.brand_name,'total_km':res.coord_km,
					'addrs':[{'icon_color':'1','icon_img':'丢','branch_name':res.begin_branch,'time':res.begin_time},
					{'icon_color':'2','icon_img':'追','branch_name':res.catch_branch,'time':res.find_time},
					{'icon_color':'3','icon_img':'还','branch_name':res.end_branch,'time':res.end_time}],
					'remain':res.remain_km,'end_coord_list':res.end_coord_list,
					'catch_coord_list':res.catch_coord_list,

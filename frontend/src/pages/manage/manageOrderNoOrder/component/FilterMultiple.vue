<template>
    <div class="FilterBox">
        ...
        <div class="filter-list">
            <span class="filter-item" :class="{active:chosen.length=='0'}" @click="handleClickAll">全部</span>
...
<script>
  export default {
    ...
    methods: {
      // 给父级组件调用的方法，返回结果用
      getResult(){
        return this.chooseAll&&!this.isAll ? this.options.map(item=>item.id) : this.chosen
      },

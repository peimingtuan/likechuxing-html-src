...
<script>
    require("../css/carwashbeforephoto2.css")
    ...
    mounted()
    {
        ...
        $(".uploadphoto").change(function () {
            let pic = $(this).parent().siblings(".preview"),//本地存储图片的路径
    ...
    methods: {
        ...
        submitInfo(){
            ...
            myAjax.post(getApiUrl('/wash/work-order/before-upload'),{
                token:sessionStorage.getItem("access_token"),

...
export default function waterMark (settings) {
  ...
  var defaultSettings = {
    ...
    watermark_width: 320,//水印宽度
    watermark_height: 80,//水印长度
    watermark_angle: 7//水印倾斜度数
  };
  ...
  for (var i = 0; i < defaultSettings.watermark_rows; i++) {
    ...
    for (var j = 0; j < defaultSettings.watermark_cols; j++) {
      ...
      mask_div.style.padding = '20px 0';
      mask_div.style.boxSizing = 'border-box';
  ...
  let old_mark = document.querySelector('#like-waterMark')
  if (old_mark) document.body.removeChild(old_mark)
